package com.anyaut.automation.AnyautAutomationProject.listener;
		...
		if (!result.isSuccess()) {
			...
			try {
				String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath()
						+ "\\src\\main\\java\\com\\anyaut\\automation\\AnyautAutomationProject\\";
	...
	public void onTestSuccess(ITestResult arg0) {
		...
		if (arg0.isSuccess()) {
			...
			try {
				String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath()
						+ "\\src\\main\\java\\com\\anyaut\\automation\\AnyautAutomationProject\\";
				File destFile = new File((String) reportDirectory + "\\screenshot\\" + methodName + "_"
						+ formater.format(calendar.getTime()) + ".png");
